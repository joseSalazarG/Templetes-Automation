...
public class Hooks {
	...
	/**
	 * Verifica si un elemento especificado por su localizador está visible en la página.
	 *
	 * @param locator El localizador del elemento.
	...
	/**
	 * Verifica si existe un elemento en la página, identificado por su localizador XPath.
	 *
